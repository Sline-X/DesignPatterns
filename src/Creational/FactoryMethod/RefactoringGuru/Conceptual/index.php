 ...
 * должен возвращать объект класса Продукт. Подклассы
 * Создателя обычно предоставляют реализацию этого метода.
 */
abstract class Creator
{
    ...
    public function someOperation(): string
    {
        ...
        $result = 'Creator: Thre same creator\'s code has worked with ' .
            $product->operation();
 ...
 * его базовый интерфейс. Пока клиент продолжает работать с создателем
...
{
    // ...
    echo "Client: I'm not aware of the creator's, but it still works. \n"
